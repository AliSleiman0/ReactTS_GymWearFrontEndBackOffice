            ...
            return (
                <div className="w-full h-full flex justify-between items-end xl:gap-5">
                    <div className="flex h-full flex-col justify-between items-start">
                        ...
                        <span className="font-bold text-xl xl:text-2xl 2xl:text-3xl 3xl:text-4xl m-0 p-0 self-center">
                            {total}
                        </span>
                        <button
                            onClick={() => {
        ...
        if (isLoading) {
            return (
                <div className="w-full h-full p-0 m-0 flex flex-col items-start gap-3 xl:gap-4">
                    <span className="text-2xl xl:text-2xl 2xl:text-2xl font-bold">
                        {title || 'No title'}
                    </span>
                        ...
                        {chartData ? (
                            <ResponsiveContainer width="100%" height="100%">
                                <BarChart data={chartData}>
                                    ...
                                    <XAxis dataKey="name" interval={title == "Top Selling Products" ? undefined : 0} tick={{ fontSize: 8 }} />
                                    <Tooltip
                                        contentStyle={{
                                            background: color,
                                            borderRadius: '5px',
                        ...
                        {chartAreaData ? (
                            <ResponsiveContainer width="100%" height="100%">
                                <AreaChart data={chartAreaData}  >
                                    ...
                                    <Area
                                        type="monotone"
                                        dataKey="value"  // Changed from multiple fields to a single 'value'
                                        stroke="#8884d8"
                                        fill="#8884d8"
                                    />
                                </AreaChart>
